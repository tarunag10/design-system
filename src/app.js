// ===== src/theme.js =====
const __m1__Users_tarunagarwal_Documents_1_App_Developement_Tarun_Open_Access_UK_design_system_src_theme_js = (() => {
...
// ===== src/tokens.js =====
const __m3__Users_tarunagarwal_Documents_1_App_Developement_Tarun_Open_Access_UK_design_system_src_tokens_js = (() => {
const tokens = {
  color: {
    background: '#ffffff',
    text: '#18212f',
...
function filterComponentInventory(components, filters = {}) {
...
function createTokenExport(tokenSet = tokens) {
...
function createComponentRecipe(pattern = {}) {
...
function createDesignSystemHandoff(patterns = componentPatterns, tokenSet = tokens) {
...
function createLocalActionPack(patterns = componentPatterns, selectedNames = [], options = {}) {
...
return { tokens, currentGuidance, contrastPair, getContrastSummary, componentPatterns, filterComponentInventory, createTokenExport, createComponentRecipe, createDesignSystemHandoff, createLocalActionPack, serializeSavedShortlist, parseSavedShortlist };
})();

// ===== generated dependency bindings =====

const { initTheme: initTheme } = __m1__Users_tarunagarwal_Documents_1_App_Developement_Tarun_Open_Access_UK_design_system_src_theme_js;
...
const { tokens: tokens, currentGuidance: currentGuidance, contrastPair: contrastPair, getContrastSummary: getContrastSummary, componentPatterns: componentPatterns, filterComponentInventory: filterComponentInventory, createTokenExport: createTokenExport, createComponentRecipe: createComponentRecipe, createDesignSystemHandoff: createDesignSystemHandoff, createLocalActionPack: createLocalActionPack, serializeSavedShortlist: serializeSavedShortlist, parseSavedShortlist: parseSavedShortlist } = __m3__Users_tarunagarwal_Documents_1_App_Developement_Tarun_Open_Access_UK_design_system_src_tokens_js;
